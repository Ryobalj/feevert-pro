          ...
          {displayedReviews.map((review, index) => (
            ...
            >
              <div className="glass-card h-full flex flex-col relative overflow-hidden group hover:border-emerald-400/30 transition-all duration-300">
                {/* Quote Watermark */}
                <div className="absolute -top-4 -right-2 text-8xl text-white/[0.03] font-serif select-none pointer-events-none group-hover:text-emerald-400/[0.06] transition-colors duration-500">
                  ❝
                </div>
                ...
                <div className="p-6 flex flex-col h-full relative z-10">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="relative">
                      <div className="absolute inset-0 bg-emerald-400/0 group-hover:bg-emerald-400/20 rounded-full blur-sm transition-all duration-300" />
