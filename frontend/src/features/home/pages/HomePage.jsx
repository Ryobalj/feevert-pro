  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                  ...
                  <Link to={`/projects/${project.id}`} className="block group h-full">
                    <div className="glass-card h-full flex flex-col overflow-hidden hover:border-emerald-400/30 transition-all duration-300 p-0">
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-white/5">
                          <span className="text-xs px-3 py-1 rounded-full bg-emerald-500/15 text-emerald-400 border border-emerald-500/20 font-semibold">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              {counters.projects > 0 && (
                <motion.div
                  ...
                  className="glass-card group hover:border-emerald-400/30 hover:shadow-lg hover:shadow-emerald-500/10 transition-all duration-500"
                >
                  <div className="p-6 text-center">
                    <div className="w-14 h-14 mx-auto mb-4 rounded-2xl glass flex items-center justify-center text-3xl group-hover:scale-110 group-hover:border-emerald-400/30 transition-all duration-300">
                      📁
                    </div>
      ...
      <section className="relative py-24 md:py-32 overflow-hidden">
        ...
        />
        <motion.div
          className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-green-400/10 rounded-full blur-[100px]"
        ...
        <div className="container-main relative z-10 text-center max-w-2xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact"
                className="group relative bg-white text-[#0d3320] px-10 py-4 rounded-full font-bold text-lg shadow-2xl shadow-black/20 overflow-hidden hover:shadow-xl transition-all"
              >
                <motion.div
