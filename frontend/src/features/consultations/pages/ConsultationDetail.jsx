...
const ConsultationDetail = () => {
    ...
    const loadConsultation = async () => {
      try {
        ...
        if (err.response?.status === 404) {
          setError(t('detail.error_not_found'))
  ...
  // ✅ Badilisha statusConfig kuwa na translation
          ...
          <div className="flex flex-wrap items-start justify-between gap-4 mb-8">
            <div>
              ...
              <p className="text-sm text-white/30 flex items-center gap-2">
                ...
                {t('detail.request_id')} #{consultation.id}
              </p>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <DetailCard
                ...
                value={consultation.item_name || consultation.category_name || consultation.service_name
                || t('consultation.default_title')}
              />
              <DetailCard
                ...
                label={t('detail.assigned_to')}
                value={consultation.assigned_to_name || t('detail.pending_assignment')}
              />
            </div>
            ...
            <DetailCard
              ...
              label={t('detail.requested_on')}
              value={formatCreatedDate(consultation.created_at)}
            />
          </div>
        </motion.div>
      </div>
