...
from consultations.models import ConsultationService, ConsultationCategory
...
class Booking(BaseModel):
    ...
    # Flat services model: the chosen item is a sub-category (optional context).
    category = models.ForeignKey(ConsultationCategory, on_delete=models.SET_NULL, null=True, blank=True, related_name='bookings')
